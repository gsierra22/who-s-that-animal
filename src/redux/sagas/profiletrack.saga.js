...
import profileTrack from '../reducers/profiletrack.reducer';
...
function* fetchProfile(action) {
  ...
  try {
    //console.log(action.payload)
      ...
      yield put({ type: 'SET_TRACKPROFILE', payload: track.data });
